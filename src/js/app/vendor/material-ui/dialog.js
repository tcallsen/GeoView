...
var WindowListenable = require('../../../../../node_modules/material-ui/lib/mixins/window-listenable');
var CssEvent = require('../../../../../node_modules/material-ui/lib//utils/css-event');
var KeyCode = require('../../../../../node_modules/material-ui/lib//utils/key-code');
var Transitions = require('../../../../../node_modules/material-ui/lib//styles/transitions');
var StylePropable = require('../../../../../node_modules/material-ui/lib//mixins/style-propable');
var FlatButton = require('../../../../../node_modules/material-ui/lib//flat-button');
var Overlay = require('../../../../../node_modules/material-ui/lib//overlay');
var Paper = require('../../../../../node_modules/material-ui/lib//paper');
...
var Dialog = React.createClass({
  ...
  getStyles: function getStyles() {
    ...
    var content = {
      ...
      position: 'relative',
      width: (this.props.elevation) ? '98%' : '75%' ,
      maxWidth: (this.props.elevation) ? 'auto' : spacing.desktopKeylineIncrement * 12 ,
      margin: '0 auto',
      zIndex: 10
    };

    var body = {
      padding: (this.props.elevation) ? 6 : spacing.desktopGutter ,
    ...
    var title = {
      margin: 0,
      //padding: gutter + gutter + '4 ' + gutter,
